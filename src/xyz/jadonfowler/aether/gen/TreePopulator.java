...
public class TreePopulator extends BlockPopulator {
	...
	public void populate(World world, Random r, Chunk chunk) {
		if ((!chunk.getBlock(0, 0, 0).getBiome().equals(Biome.FOREST))
				&& (!chunk.getBlock(0, 0, 0).getBiome()
						.equals(Biome.FOREST_HILLS)) && (!this.moreTrees)
				&& (this.random.nextDouble() > 0.04D)) {
			return;
		}
		...
		TreeType[] types = { TreeType.TREE, TreeType.BIRCH, TreeType.BIG_TREE,
